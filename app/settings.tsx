  ...
  const profileSettings: SettingItem[] = [
    {
      ...
      subtitle: 'Pseudo, avatar, bio',
      icon: 'person-circle',
      type: 'navigation',
      onPress: () => Alert.alert('Profil', 'Édition du profil'),
    },
    {
      id: 'gaming-preferences',
      title: 'Préférences gaming',
      subtitle: 'Jeux, disponibilités, niveau',
      icon: 'game-controller',
      type: 'navigation',
      onPress: () => Alert.alert('Gaming', 'Préférences gaming'),
    },
  ];
    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          {renderSection('👤 Profil', profileSettings)}
